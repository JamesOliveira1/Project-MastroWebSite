...
<body class="titan-page">
  ...
  <!-- 8. Custom Titan Footer -->
  <footer class="titan-footer dark-blueprint py-5 border-top border-secondary position-relative">
    <div class="blueprint-grid" style="z-index: 0; pointer-events: none;"></div>
    <div class="container position-relative" style="z-index: 2;">
      <div class="row align-items-center">
        
        <!-- Col 1: Logo and Social -->
        <div class="col-lg-4 col-md-6 mb-4 mb-lg-0 text-center text-md-start">
          <a href="../index.html"><img src="../assets/img/logo branco.png" alt="Mastro D'Ascia" class="img-fluid mb-3" style="max-height: 50px;"></a>
          <div class="social-links-titan mt-2 d-flex justify-content-center justify-content-md-start gap-3">
            <a href="https://api.whatsapp.com/send?phone=5548991466864" target="_blank" title="WhatsApp" class="text-light fs-4"><i class="bi bi-whatsapp"></i></a>
            <a href="https://www.facebook.com/MastroDAscia" target="_blank" title="Facebook" class="text-light fs-4"><i class="bi bi-facebook"></i></a>
            <a href="https://www.instagram.com/mastrodascia" target="_blank" title="Instagram" class="text-light fs-4"><i class="bi bi-instagram"></i></a>
            <a href="https://www.youtube.com/@mastrodascia1115" target="_blank" title="YouTube" class="text-light fs-4"><i class="bi bi-youtube"></i></a>
          </div>
        </div>

        <!-- Col 2: Links and Dropdown -->
        <div class="col-lg-4 col-md-6 mb-4 mb-lg-0 text-center">
          <ul class="list-unstyled titan-footer-links m-0">
            <li class="mb-3"><a href="../index.html" class="text-decoration-none text-light opacity-75"><i class="bi bi-globe me-2"></i>Ver site principal</a></li>
            <li class="mb-3 dropdown">
              <a href="#" class="text-decoration-none text-light opacity-75 dropdown-toggle" id="modelsDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                <i class="bi bi-water me-2"></i>Outros Modelos
              </a>
              <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="modelsDropdown">
                <li><a class="dropdown-item" href="../portfolio/7CC.html">Nomad 7 CC</a></li>
                <li><a class="dropdown-item" href="../portfolio/8CC.html">Nomad 8 CC</a></li>
                <li><a class="dropdown-item" href="../portfolio/7XF.html">7 XF</a></li>
                <li><a class="dropdown-item" href="../portfolio/titan-cc.html">Titan CC</a></li>
              </ul>
            </li>
            <li><a href="mailto:comercial@mastrodascia.com.br" class="text-decoration-none text-light opacity-75"><i class="bi bi-envelope me-2"></i>Contato por e-mail</a></li>
          </ul>
        </div>

        <!-- Col 3: Contact Email Display -->
        <div class="col-lg-4 col-md-12 text-center text-lg-end">
          <h5 class="text-uppercase text-accent mb-2" style="font-family: var(--font-tech); letter-spacing: 1px;">E-mail Comercial</h5>
          <a href="mailto:comercial@mastrodascia.com.br" class="text-light fs-5 text-decoration-none">comercial@mastrodascia.com.br</a>
        </div>
      ...
      <div class="row align-items-center text-center text-md-start">
        <div class="col-md-6 mb-3 mb-md-0">
          <p class="mb-0 small text-light opacity-50">&copy; <script>document.write(new Date().getFullYear())</script> Mastro D'Ascia - Todos os direitos reservados.</p>
        </div>
        <div class="col-md-6 text-md-end text-light opacity-50 small">
          Este site é protegido pelo <img src="https://www.gstatic.com/recaptcha/api2/logo_48.png" alt="reCAPTCHA" style="height: 20px; vertical-align: middle;"> reCAPTCHA e está sujeito à 
          <a href="https://policies.google.com/privacy" target="_blank" class="text-light text-decoration-underline">Política de Privacidade</a> e aos 
          <a href="https://policies.google.com/terms" target="_blank" class="text-light text-decoration-underline">Termos de Serviço</a> do Google.
        </div>
      </div>
    </div>
  </footer>
  ...
  <a href="https://api.whatsapp.com/send?phone=5548991466864&text=Ol%C3%A1%2C%20estou%20na%20p%C3%A1gina%20da%20Titan%20Cabin" target="_blank" class="titan-float-wpp" title="Fale conosco no WhatsApp">
