          ...
          <form class="tech-form" action="../forms/send_landingpage_cabin-form.php" method="post" id="titanForm">
            <div class="row">
              <div class="col-md-12 mb-3">
                <input type="text" name="full_name" id="full_name" class="form-control" placeholder="Seu Nome Completo" required pattern="^[A-Za-zÀ-ÿ\s]+$" title="Por favor, insira apenas letras" oninput="this.value = this.value.replace(/[^a-zA-ZÀ-ÿ\s]/g, '')">
              </div>
              <div class="col-md-6 mb-3">
                <input type="email" name="email" id="email" class="form-control" placeholder="Seu E-mail" required title="Por favor, insira um endereço de e-mail válido">
              </div>
              <div class="col-md-6 mb-3">
                <input type="tel" name="phone" id="phone" class="form-control" placeholder="WhatsApp / Telefone (apenas números)" required pattern="[0-9]+" minlength="10" maxlength="15" oninput="this.value = this.value.replace(/[^0-9]/g, '')" title="Por favor, insira apenas números (com DDD)">
              </div>
              <div class="col-12 mb-3">
                <textarea name="message" id="message" class="form-control" rows="4" placeholder="Mensagem ou dúvidas adicionais..."></textarea>
              </div>
              <div class="col-12">
                <button type="submit" class="btn-submit-tech w-100">Solicitar Orçamento</button>
              </div>
            </div>
        ...
        <div class="row g-4 align-items-start">
          <div class="col-lg-5">
            <div class="titan-footer-brand">
              <a href="../index.html" class="titan-footer-logo" aria-label="Ir para o site principal da Mastro D'Ascia">
                <img src="../assets/img/logo branco.png" alt="Mastro D'Ascia">
              </a>
              <p class="titan-footer-copy">
                A Titan Cabin traduz a assinatura da Mastro D'Ascia em uma embarcacao de alto desempenho, acabamento preciso e configuracao sob medida.
              </p>
          ...
          <div class="col-md-5 col-lg-3">
            <div class="titan-footer-card">
              <span class="titan-footer-kicker">Navegacao</span>
              <h3>Continue a experiencia</h3>
              <ul class="titan-footer-links">
                <li><a href="../index.html">Ver site principal</a></li>
                <li><a href="#lead-gen" class="scrollto">Solicitar orcamento</a></li>
                <li><a href="mailto:comercial@mastrodascia.com.br">comercial@mastrodascia.com.br</a></li>
              </ul>
            </div>
          </div>
          ...
          <div class="col-md-7 col-lg-4">
            <div class="titan-footer-card">
              ...
              <h3>Explore outras configuracoes da linha</h3>
              <label class="visually-hidden" for="footerModelSelect">Selecione outro modelo</label>
              <div class="titan-model-select-wrap">
                <select id="footerModelSelect" class="titan-model-select" aria-label="Selecionar outro modelo">
                  <option value="">Escolha um modelo para abrir</option>
                  <option value="../portfolio/TitanCC.html">Titan CC</option>
                  <option value="../portfolio/Commuter.html">Commuter</option>
                  <option value="../portfolio/8CC.html">Nomad 8 CC</option>
                  <option value="../portfolio/85XF.html">Nomad 8.5 XF</option>
                </select>
                <button type="button" class="titan-model-go" id="footerModelGo">Abrir</button>
              </div>
              <p class="titan-footer-note">
                Se preferir, nossa equipe comercial orienta qual plataforma faz mais sentido para o seu perfil de navegacao.
              </p>
            </div>
          </div>
        </div>
