    ...
    <div class="container" data-aos="zoom-in">
      <div class="row justify-content-center">
        <div class="col-lg-8 text-center">
          ...
          <form class="tech-form" action="#" method="post" id="titanForm" onsubmit="event.preventDefault(); alert('Formulário enviado com sucesso! Entraremos em contato em breve.');">
            <div class="row">
              <div class="col-md-12 mb-3">
                <input type="text" class="form-control" placeholder="Seu Nome Completo" required pattern="^[A-Za-zÀ-ÿ\s]+$" title="Por favor, insira apenas letras" oninput="this.value = this.value.replace(/[^a-zA-ZÀ-ÿ\s]/g, '')">
              </div>
              <div class="col-md-6 mb-3">
                <input type="email" class="form-control" placeholder="Seu E-mail" required title="Por favor, insira um endereço de e-mail válido">
              </div>
              <div class="col-md-6 mb-3">
                <input type="tel" class="form-control" placeholder="WhatsApp / Telefone (apenas números)" required pattern="[0-9]+" minlength="10" maxlength="15" oninput="this.value = this.value.replace(/[^0-9]/g, '')" title="Por favor, insira apenas números (com DDD)">
              </div>
