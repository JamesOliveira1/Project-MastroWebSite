    ...
    <div class="container" data-aos="zoom-in">
      <div class="row justify-content-center">
        <div class="col-lg-8 text-center">
          ...
          <form class="tech-form" action="processa_formulario.php" method="post" id="titanForm">
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                <input type="tel" name="telefone" class="form-control" placeholder="WhatsApp / Telefone (Apenas números)" required pattern="[0-9]+" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
              </div>
