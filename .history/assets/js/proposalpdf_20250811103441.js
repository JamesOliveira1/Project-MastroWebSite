...
// Adiciona fotos com tamanhos fixos // dois primeiros são x e y, os dois ultimos são largura e altura
if (foto1) await addFixedImage(doc, foto1, 18.75, 90, 133, 95); 
...
setWhiteBoldStyle()
doc.setFontSize(13);
doc.text(safeSplitTextToSize(modelInfo, 260), 22, 95.18, { baseline: "top", lineHeightFactor: 1.8 });
setBoldStyle();
doc.setFontSize(13);
doc.text(safeSplitTextToSize(seriesItems, 260), 119, 94.58, { baseline: "top", lineHeightFactor: 1.6 });
doc.text(safeSplitTextToSize(optionsText, 260), 213, 94.58, { baseline: "top", lineHeightFactor: 1.6 }); 
...
// Alinha à direita no ponto (275,36) com largura máxima
doc.text(basicSetup, 275, 36, {
  align: "right",
  baseline: "top",
  maxWidth: 160 // largura máxima em mm
});
