...
setBoldStyle();
doc.setTextColor(0, 79, 145); // #004f91
doc.setFontSize(12); // ajuste se necessário

const mmToPt = 2.83465;
const larguraMaxPt = (275 - 121) * mmToPt; // largura em pontos
const textoQuebrado = doc.splitTextToSize(basicSetup, larguraMaxPt);

// Alinha à direita no ponto (275,36), respeitando largura máxima
doc.text(textoQuebrado, 275, 36, {
  align: "right",
  baseline: "top"
});
