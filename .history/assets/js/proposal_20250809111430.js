...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (select && typeof mastroproposta === 'object') {
        ...
        // Quando selecionar um modelo, preenche os campos de info, itens de série, motores e imagens
select.addEventListener('change', function () {
    ...
    var motorImgInput = document.getElementById('proposalmotorimg');
    ...
    if (selected && mastroproposta[selected]) {
        ...
        if (motorSelect) {
            ...
            // Evento para atualizar o hidden da imagem do motor quando trocar o select
            motorSelect.addEventListener('change', function () {
                if (motorImgInput && this.value.trim() !== "") {
                    motorImgInput.value = `assets/img/motor/${this.value}.jpg`;
