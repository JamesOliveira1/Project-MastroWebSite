...
setBoldStyle();
doc.setFontSize(13);
doc.text(safeSplitTextToSize(seriesItems, 260), 119, 91.60, { baseline: "top", lineHeightFactor: 1.6 });
doc.text(safeSplitTextToSize(optionsText, 260), 213, 91.60, { baseline: "top", lineHeightFactor: 1.6 }); 
