...
const boatOptions = {
  "7CC": {
    ...
    itens:
      "2 vigias laterais, 4 Bombas de porão com automático,  Escada de popa em aço inox, Estofamento em courvin anti-mofo, Fiação elétrica estanhada e codificada, Gaiuta 19 polegadas, Guarda-mancebo em inox 316l, Luzes de navegação, Porta-caniço no costado, Targa em inox 316l, WC elétrico",
    options: [
      { name: "Capa de Proteção", price: "3500.00" },
      { name: "Carreta de encalhe", price: "22815.00" },
      { name: "Guincho elétrico", price: "7230.60" },
      { name: "Kit de lavagem com água doce", price: "1100.00" },
  ...
  "8CC": {
    ...
    itens:
      "6 Bombas de porão com automático, Escada de popa em aço inox, Estofamento em courvin anti-mofo, Fiação elétrica estanhada e codificada, Luzes de navegação, Porta caniço no costado",
    options: [
      { name: "Caixas de peixe removíveis", price: "1640.87" },
      { name: "Capa de Proteção", price: "3500.00" },
      { name: "Carreta de encalhe", price: "22815.00" },
  ...
  "8XF": {
    ...
    itens:
      "2 vigias laterais, 6 Bombas de porão com automático, Escada de popa em aço inox, Estofamento em courvin anti-mofo, Fiação elétrica estanhada e codificada, Gaiuta 19 polegadas, Guarda-mancebo em inox 316l, Luzes de navegação, Porta-caniço no costado, Targa em inox 316l, WC elétrico",
    options: [
      { name: "Banheiro Fechado", price: "4200.00" },
      { name: "Capa de Proteção", price: "3500.00" },
      { name: "Carreta de encalhe", price: "22815.00" },
  ...
  "8.5XS": {
    ...
    itens:
      "6 Bombas de porão com automático, Escada de popa em aço inox, Fiação elétrica estanhada e codificada, Guarda-mancebo em inox 316l, Luzes de navegação, Posto de comando fechado",
    options: [
      { name: "2 vigias laterais", price: "2423.36" },
      { name: "Ar condicionado", price: "24707.08" },
  ...
  "8.5CC": {
    ...
    itens:
      "6 Bombas de porão com automático, Escada de popa em aço inox, Estofamento em courvin anti-mofo, Fiação elétrica estanhada e codificada, Kit de lavagem com água doce, Luzes de navegação, Porta-caniço no costado",
    options: [
      { name: "Capa de Proteção", price: "5280.00" },
      { name: "Carreta de encalhe", price: "22815.00" },
      { name: "Guincho elétrico", price: "7230.60" },
  ...
  "8.5XF": {
    ...
    itens:
      "2 vigias laterais, 6 Bombas de porão com automático, Escada de popa em aço inox, Estofamento em courvin anti-mofo, Fiação elétrica estanhada e codificada, Gaiuta 19 polegadas, Guarda-mancebo em inox 316l, Kit de lavagem com água doce, Luzes de navegação, Porta-caniço no costado, Targa em fibra, WC elétrico",
    options: [
      { name: "Ar condicionado", price: "24707.08" },
      { name: "Banheiro Fechado", price: "4200.00" },
      { name: "Capa de Proteção", price: "5280.00" },
  ...
  "Commuter": {
    ...
    itens:
      "6 Bombas de porão com automático, Escada de popa em aço inox, Estofamento em courvin anti-mofo, Fiação elétrica estanhada e codificada, Guarda-mancebo em inox 316l, Kit de lavagem com água doce, Luzes de navegação, WC elétrico",
    options: [
      { name: "Ar condicionado", price: "24707.08" },
