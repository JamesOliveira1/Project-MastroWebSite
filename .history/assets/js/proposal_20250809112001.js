    ...
    if (select && typeof mastroproposta === 'object') {
        ...
        select.addEventListener('change', function () {
            ...
            if (selected && mastroproposta[selected]) {
                ...
                // Preencher campos hidden das fotos e imagem do motor
...
// Preencher campo hidden da imagem do motor baseado no motor selecionado
const motorImgInput = document.getElementById("proposalmotorimg");
const motorName = mastroproposta[selected].motorConfig || "";
if (motorImgInput && motorName.trim() !== "") {
    motorImgInput.value = `assets/img/motor/${motorName}.jpg`;
}
