...
function mostrarArtigo(idArtigo) {
  ...
  const mostrarComTransicao = () => {
    ...
    artigoSelecionado.style.transform = 'translateX(6px)';
    requestAnimationFrame(() => {
      artigoSelecionado.style.opacity = '1';
      artigoSelecionado.style.transform = 'translateX(0)';
    });
  ...
  if (artigoAtual && artigoAtual !== artigoSelecionado) {
    ...
    artigoAtual.style.transform = 'translateX(0)';
    requestAnimationFrame(() => {
      artigoAtual.style.opacity = '0';
      artigoAtual.style.transform = 'translateX(6px)';
    });
