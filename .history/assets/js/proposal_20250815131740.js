...
const mastroproposta = {
    ...
    "8.5CC": {
        ...
        serieitens: [
            ...
            { name: "Estofamento em courvin anti-mofo" },
            { name: "Fiação elétrica estanhada e codificada" },
            { name: "Kit de lavagem com água doce" },
            { name: "Luzes de navegação" },
            { name: "Porta-caniço no costado" }
        ],
        options: [
...
if (selected && mastroproposta[selected]) {
  ...
  if (selected === 'Titan CC') {
    document.getElementById('proposaldifferentials').value = 'Texto diferente para o Titan CC';
  } else {
    document.getElementById('proposaldifferentials').value = ''; // volta ao texto original
  }
}