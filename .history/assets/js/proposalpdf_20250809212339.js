...
const lineHeight = 1.5;   // espaçamento entre linhas
...
setBoldStyle();
doc.setTextColor(0, 79, 145); // Cor #004f91
doc.setFontSize(12); // ajuste conforme necessário

// Calcula a largura máxima em pontos
const mmToPt = 2.83465;
const larguraMaxPt = (275 - 121) * mmToPt;

// Quebra o texto para caber no limite
const textoFormatado = doc.splitTextToSize(basicSetup, larguraMaxPt);

// Alinha à direita na coordenada X = 275, Y = 36 (topo do texto)
doc.text(textoFormatado, 275, 36, {
  align: "right",
  baseline: "top"
});
