...
if (foto1) {
  doc.addImage(foto1, "JPEG", 18, 90, 133, 95); // Foto principal
}
if (foto2) {
  doc.addImage(foto2, "JPEG", 158, 90, 80, 45); // Foto secundária 1
}
if (foto3) {
  doc.addImage(foto3, "JPEG", 158, 140, 80, 45); // Foto secundária 2
}
