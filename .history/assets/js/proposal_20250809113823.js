        ...
        select.addEventListener('change', function () {
            ...
            if (selected && mastroproposta[selected]) {
                ...
                if (motorSelect) {
                    ...
                    // CORREÇÃO: Adicionar listener para quando um motor for selecionado
                    motorSelect.addEventListener('change', function() {
                        ...
                        if (selectedMotor && selectedMotor.trim() !== "" && motorImgInput) {
                            ...
                            const motorFileName = selectedMotor
                                .replace(/\s+/g, "_")           // Substituir espaços por underscore
                                .replace(/[^\w\-_.]/g, "")     // Remover caracteres especiais
                                .toLowerCase();                // Converter para minúsculas
                            
                            // Definir o caminho da imagem
                            const motorImagePath = `assets/img/motor/${motorFileName}.jpg`;
                ...
                // CORREÇÃO: Limpar o campo da imagem do motor quando modelo muda
                const motorImgInput = document.getElementById("proposalmotorimg");
