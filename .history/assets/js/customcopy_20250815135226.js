...
const boatOptions = {
  "7CC": {
    ...
    itens:
      "2 vigias laterais, 4 Bombas de porão com automático, Kit de lavagem de deck, Escada de popa em aço inox, Estofamento em courvin anti-mofo, Fiação elétrica estanhada e codificada, Gaiuta 19 polegadas, Guarda-mancebo em inox 316l, Luzes de navegação, Porta-caniço no costado, Targa em inox 316l, WC elétrico",
    options: [
  ...
  "7XS": {
    ...
    itens:
      "4 Bombas de porão com automático, Kit de lavagem de deck, Escada de popa em aço inox, Fiação elétrica estanhada e codificada, Gaiuta 19 polegadas, Luzes de navegação, Posto de comando fechado",
    options: [
  ...
  "8CC": {
    ...
    itens:
      "6 Bombas de porão com automático, Kit de lavagem de deck, Escada de popa em aço inox, Estofamento em courvin anti-mofo, Fiação elétrica estanhada e codificada, Luzes de navegação, Porta caniço no costado",
    options: [
      { name: "Caixas de peixe removíveis", price: "1640.87" },
      { name: "Capa de Proteção", price: "3500.00" },
      { name: "Carreta de encalhe", price: "22815.00" },
  ...
  "8XF": {
    ...
    itens:
      "2 vigias laterais, Kit de lavagem de deck, 6 Bombas de porão com automático, Escada de popa em aço inox, Estofamento em courvin anti-mofo, Fiação elétrica estanhada e codificada, Gaiuta 19 polegadas, Guarda-mancebo em inox 316l, Luzes de navegação, Porta-caniço no costado, Targa em inox 316l, WC elétrico",
    options: [
      { name: "Banheiro Fechado", price: "4200.00" },
      { name: "Capa de Proteção", price: "3500.00" },
      { name: "Carreta de encalhe", price: "22815.00" },
  ...
  "8XS": {
    ...
    itens:
      "6 Bombas de porão com automático, Kit de lavagem de deck, Escada de popa em aço inox, Fiação elétrica estanhada e codificada, Gaiuta 19 polegadas, Luzes de navegação, Posto de comando fechado",
    options: [
      { name: "2 vigias laterais", price: "2423.36" },
  ...
  "8.5XS": {
    ...
    itens:
      "6 Bombas de porão com automático, Kit de lavagem de deck, Escada de popa em aço inox, Fiação elétrica estanhada e codificada, Guarda-mancebo em inox 316l, Luzes de navegação, Posto de comando fechado",
    options: [
      { name: "2 vigias laterais", price: "2423.36" },
      { name: "Ar condicionado", price: "24707.08" },
  ...
  "8.5CC": {
    ...
    itens:
      "6 Bombas de porão com automático, Escada de popa em aço inox, Estofamento em courvin anti-mofo, Fiação elétrica estanhada e codificada, Kit de lavagem de deck, Luzes de navegação, Porta-caniço no costado",
    options: [
      { name: "Capa de Proteção", price: "5280.00" },
      { name: "Carreta de encalhe", price: "22815.00" },
      { name: "Guincho elétrico", price: "7230.60" },
  ...
  "8.5XF": {
    ...
    itens:
      "2 vigias laterais, 6 Bombas de porão com automático, Escada de popa em aço inox, Estofamento em courvin anti-mofo, Fiação elétrica estanhada e codificada, Gaiuta 19 polegadas, Guarda-mancebo em inox 316l, Kit de lavagem de deck, Luzes de navegação, Porta-caniço no costado, Targa em fibra, WC elétrico",
    options: [
      { name: "Ar condicionado", price: "24707.08" },
      { name: "Banheiro Fechado", price: "4200.00" },
      { name: "Capa de Proteção", price: "5280.00" },
  ...
  "Commuter": {
    ...
    itens:
      "6 Bombas de porão com automático, Escada de popa em aço inox, Estofamento em courvin anti-mofo, Fiação elétrica estanhada e codificada, Guarda-mancebo em inox 316l, Kit de lavagem de deck, Luzes de navegação, WC elétrico",
    options: [
      { name: "Ar condicionado", price: "24707.08" },
  ...
  itens: "6 Bombas de porão com automático, Kit de lavagem de deck, Escada de popa em aço inox, Estofamento em courvin anti-mofo, Fiação elétrica estanhada e codificada, Luzes de navegação, WC elétrico",
  options: [
    { name: "Capa de Proteção", price: "5280.00" },
    { name: "Corrimão de popa", price: "1800.00" },
    { name: "Carreta de encalhe", price: "35100.00" },
...
document.querySelectorAll(".boat-option").forEach((option) => {
  option.addEventListener("click", function () {
    ...
    selectedBoat.options.forEach((option) => {
      ...
      optionLink.innerHTML = `${option.name} <span class="option-price" style="display: none;">-  ${formattedPrice}</span>`;
...
document.getElementById("customBoatForm")
  .addEventListener("submit", function (event) {
    ...
    grecaptcha.execute("6LfEIoYqAAAAAH-P0jb0mVzWDm4bkbmgXHpk7jsL", { action: "submit" })
      .then(function (token) {
        ...
        formData.append(
          "clientEmail",
          form.querySelector("#clientEmail").value || ""
        );    
        ...
        formData.append(
          "clientPhone",
          form.querySelector("#clientPhone").value || ""
        );
        formData.append(
          "additionalNotes",
  ...
  // Seleciona automaticamente o modelo pelo hash da URL, se existir
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (hash && boatOptions[hash]) {
    ...
    if (boatDiv) {
      boatDiv.click();
      // Scroll até o formulário, se desejar:
       document.getElementById("customBoatForm").scrollIntoView({ behavior: "smooth" });
    }
  }
});