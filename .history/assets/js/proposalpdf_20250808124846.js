...
// Definir cores em RGB (jsPDF funciona melhor com RGB do que hex)
...
doc.setFont("helvetica", "normal"); // Usar helvetica ao invés de arial
doc.setFontSize(14);
doc.setTextColor(darkBlue[0], darkBlue[1], darkBlue[2]); // RGB ao invés de hex
...
doc.setFont("helvetica", "bold"); // Usar helvetica bold
doc.setFontSize(32);
doc.setTextColor(white[0], white[1], white[2]); // RGB branco
...
// ALTERNATIVA: Se você quiser usar Arial especificamente, adicione esta linha antes de usar:
// doc.addFont('Arial', 'Arial', 'normal');
// doc.addFont('Arial', 'Arial', 'bold');
// Então você pode usar doc.setFont("Arial", "normal") ou doc.setFont("Arial", "bold")
