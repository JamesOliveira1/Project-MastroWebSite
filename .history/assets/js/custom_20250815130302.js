...
const boatOptions = {
  ...
  Cabin: {
    ...
    itens:
      "6 Bombas de porão com automático, Escada de popa em aço inox, Estofamento em courvin anti-mofo, Fiação elétrica estanhada e codificada, Luzes de navegação, WC elétrico",
    options: [
      { name: "Capa de Proteção", price: "5280.00" },
      { name: "Corrimão de popa", price: "1800.00" },
      { name: "Carreta de encalhe", price: "35100.00" },
