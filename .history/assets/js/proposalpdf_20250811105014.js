...
setBoldStyle();
doc.setFontSize(13);
doc.text(safeSplitTextToSize(seriesItems, 260), 119, 92.10, { baseline: "top", lineHeightFactor: 1.6 });
doc.text(safeSplitTextToSize(optionsText, 260), 213, 92.10, { baseline: "top", lineHeightFactor: 1.6 }); 
...
doc.text(basicSetup, 275, 36, {
  align: "right",
  baseline: "top",
  maxWidth: 150 // largura máxima em mm
});
