...
const flagMap = {
  'pt': 'https://cdn.countryflags.com/thumbs/brazil/flag-800.png',
  'en': 'https://cdn.countryflags.com/thumbs/united-states-of-america/flag-800.png',
...
function updateFlags(lng) {
  ...
  if (mainFlagImg && flagMap[cleanLng]) {
    mainFlagImg.src = flagMap[cleanLng];
