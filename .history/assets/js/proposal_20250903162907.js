...
const mastroproposta = {
    ...
    "Cabin": {
        ...
        modelinfo: [
            ...
            { name: "Água: 120L" },
            { name: "Combustível: 1200L" },
            { name: "Motorização: 2x300HP a 2x400HP" },
            { name: "Passageiros: 16" },
        ],
        serieitens: [
            { name: "6 Bombas de porão com automático" },
...
const textosDiferenciais = {
    ...
    2: "Túnel em forma de 'M' – contribui para maior capacidade de carga, melhor amortecimento das ondas e elevação do spray, proporcionando navegação mais confortável e seca.",
    3: "Reserva de flutuação – segurança extra em qualquer situação: túnel selado e preenchido com material flutuante, servindo como reserva de flutuação.",
    4: "Casco e convés em infusão a vácuo – tecnologia de ponta que resulta em peso reduzido e alta resistência estrutural.",
    5: "Acabamento premium – uso de gelcoats anti-osmose e anti-UV, que garantem durabilidade e beleza ao longo do tempo."
  };
