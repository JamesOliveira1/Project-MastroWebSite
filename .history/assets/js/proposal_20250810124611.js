...
const mastroproposta = {
    ...
    "7XF": {
        foto1: "assets/img/produtos/7XF/foto(1).jpg",
        foto2: "assets/img/produtos/7XF/foto(4).jpg",
        foto3: "assets/img/produtos/7XF/foto(3).jpg",
        modelinfo: [
    ...
    "7XS": {
        foto1: "assets/img/produtos/7XS/foto(1).jpg",
        foto2: "assets/img/produtos/7XS/foto(5).jpg",
        foto3: "assets/img/produtos/7XS/foto(4).jpg",
        modelinfo: [
    ...
    "8CC": {
        foto1: "assets/img/produtos/8CC/fotoprincipal.jpg",
        foto2: "assets/img/produtos/8CC/foto(15).jpg",
        foto3: "assets/img/produtos/8CC/foto(8).jpg",
        modelinfo: [
            { name: "Categoria: Catamarã Center Console" },
    ...
    "8XF": {
        foto1: "assets/img/produtos/7CC/foto(1).jpg",
        foto2: "assets/img/produtos/7CC/foto(5).jpg",
        foto3: "assets/img/produtos/7CC/foto(4).jpg",
        modelinfo: [
            { name: "Categoria: Catamarã XS" },
            { name: "Comprimento: 7,70m" },
            { name: "Largura: 2,45m" },
