...
// Garante que o campo proposalmotorimg tenha o caminho correto
let motorImgPath = document.getElementById("proposalmotorimg")?.value;
if (!motorImgPath && motorConfig && motorConfig !== "—") {
...
if (motorImgPath) {
  try {
    ...
    console.warn("Erro ao carregar imagem do motor:", motorImgPath);
  }
}
