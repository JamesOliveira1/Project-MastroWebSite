...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($recaptchaResponseKeys["success"] && $recaptchaResponseKeys["score"] >= 0.5) {
        ...
        try {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'contatomastrodascia25@gmail.com';
            $mail->Password = 'ezbd tzln ygmv kypi'; // Certifique-se de usar uma senha de aplicativo
            $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
            $mail->Port = 587;            
            $mail->CharSet = 'UTF-8';        
            $mail->Encoding = 'base64';

            $mail->setFrom('contatomastrodascia25@gmail.com', 'Contato Mastro DAscia');
            $mail->addAddress('contatomastrodascia25@gmail.com', 'Contato Mastro DAscia'); // Envia para o próprio e-mail
