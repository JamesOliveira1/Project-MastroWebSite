...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // Destinatário: usa variáveis específicas do material request se existirem, depois _2, depois padrão
        $toEmail = env('SMTP_TO_EMAIL_MATERIAL', env('SMTP_TO_EMAIL_2', env('SMTP_TO_EMAIL', 'marcelo@mastrodascia.com.br')));
        $toName = env('SMTP_TO_NAME_MATERIAL', env('SMTP_TO_NAME_2', env('SMTP_TO_NAME', 'Marcelo')));
