...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    <div style='font-family: Arial, sans-serif; line-height: 1.6; color: #333;'>
        <h2 style='color: #0056b3;'>Resumo de customização de modelo feita por um <span style='color: #FF5733;'>cliente no site</span>:</h2>
        
        <!-- Dados do Cliente -->
        <div style='padding: 5px 20px; margin-bottom: 10px; background-color:rgb(245, 221, 221);'>
...
";
    ...
    try {
        ...
        $mail->addAddress('jamesio123@gmail.com');    
        $mail->CharSet = 'UTF-8';
        $mail->isHTML(true);
