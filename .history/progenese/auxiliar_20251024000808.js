...
function openEditBoatModal() {
  ...
  document.getElementById('modalTitle').textContent = 'Editar Barco';
  document.getElementById('boatId').value = currentEditingBoat.id;
  document.getElementById('boatCode').value = currentEditingBoat.codigo || '';
  document.getElementById('boatModel').value = currentEditingBoat.modelo || '';
  document.getElementById('boatClient').value = currentEditingBoat.cliente || '';
  document.getElementById('boatProgress').value = currentEditingBoat.progress || 0;
  ...
  document.getElementById('deleteBoatBtn').classList.remove('d-none');
...
async function saveBoat() {
  ...
  const boatCode = document.getElementById('boatCode').value.trim();
  const boatModel = document.getElementById('boatModel').value.trim();
  const boatClient = document.getElementById('boatClient').value.trim();
  const boatProgress = parseInt(document.getElementById('boatProgress').value, 10);
...
async function deleteBoat() {
  if (!currentEditingBoat || !confirm(`Tem certeza que deseja deletar o barco ${currentEditingBoat.codigo}?`)) {
    return;
  }
