...
CREATE TABLE servicos (
  ...
  data_inicio TEXT,
  data_concluido TEXT,
  categoria_id INTEGER,nobservacao TEXT,
  status TEXT,
  controle TEXT,
  FOREIGN KEY (barco_id) REFERENCES barcos(id),
...
CREATE TABLE servico_controles (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE INDEX IF NOT EXISTS idx_controles_barco ON controles(barco_id);
CREATE INDEX IF NOT EXISTS idx_controles_documento ON controles(documento_id);
CREATE INDEX IF NOT EXISTS idx_servico_controles_servico ON servico_controles(servico_id);
CREATE INDEX IF NOT EXISTS idx_servico_controles_controle ON servico_controles(controle_id);
