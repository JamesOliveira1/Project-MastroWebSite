...
-- === Diferenciais de modelo por usuário ===
CREATE TABLE IF NOT EXISTS diferenciais_modelo (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  usuario_id INTEGER,
...
-- Índices para diferenciais
CREATE UNIQUE INDEX IF NOT EXISTS idx_diferenciais_usuario_posicao ON diferenciais_modelo(usuario_id, posicao);
