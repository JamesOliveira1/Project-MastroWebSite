...
CREATE UNIQUE INDEX IF NOT EXISTS idx_site_itens_de_serie_nome ON site_itens_de_serie(nome);
CREATE UNIQUE INDEX IF NOT EXISTS idx_site_opcionais_nome ON site_opcionais(nome);
CREATE UNIQUE INDEX IF NOT EXISTS idx_site_motor_nome ON site_motor(nome);
