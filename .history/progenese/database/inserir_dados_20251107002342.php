...
try {
    ...
    if ($usuario == 0) {
        ...
        $stmt->execute(['Administrador', 'admin', password_hash('1234', PASSWORD_DEFAULT), 'admin@progenese.local', 'Gerente']);
    ...
    $usuariosExtras = [
        ['Leo', 'leo', '157.470@leo', 'leo@progenese.local', 'Usuário'],
        ['Marcelo', 'marcelo', 'senha123', 'marcelo@progenese.local', 'Usuário'],
        ['James', 'james', '12345678', 'james@progenese.local', 'Usuário'],
    ];
