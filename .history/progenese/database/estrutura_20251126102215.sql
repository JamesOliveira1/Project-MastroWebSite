...
-- =======================================================
CREATE TABLE site_modelo_barco (
  ...
  passageiros INTEGER,
  pernoite INTEGER,
  velocidade_cruzeiro_economico REAL,
  autonomia_cruzeiro_economico REAL,
  velocidade_maxima REAL,
  barco_e_montagem_valor REAL
);
...
CREATE TABLE site_modelo_itens_serie (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  modelo_id INTEGER NOT NULL,
  item_id INTEGER NOT NULL,
  FOREIGN KEY (modelo_id) REFERENCES site_modelo_barco(id) ON DELETE CASCADE,
  FOREIGN KEY (item_id) REFERENCES site_itens_de_serie(id) ON DELETE CASCADE
);

CREATE TABLE site_modelo_opcionais (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  modelo_id INTEGER NOT NULL,
...
CREATE TABLE site_modelo_motores (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  modelo_id INTEGER NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_site_modelo_barco_modelo ON site_modelo_barco(modelo);
CREATE INDEX IF NOT EXISTS idx_site_modelo_barco_categoria ON site_modelo_barco(categoria);

CREATE UNIQUE INDEX IF NOT EXISTS idx_unq_modelo_item_serie ON site_modelo_itens_serie(modelo_id, item_id);
CREATE INDEX IF NOT EXISTS idx_site_modelo_itens_serie_modelo ON site_modelo_itens_serie(modelo_id);
CREATE INDEX IF NOT EXISTS idx_site_modelo_itens_serie_item ON site_modelo_itens_serie(item_id);

CREATE UNIQUE INDEX IF NOT EXISTS idx_unq_modelo_opcional ON site_modelo_opcionais(modelo_id, opcional_id);
CREATE INDEX IF NOT EXISTS idx_site_modelo_opcionais_modelo ON site_modelo_opcionais(modelo_id);
CREATE INDEX IF NOT EXISTS idx_site_modelo_opcionais_opcional ON site_modelo_opcionais(opcional_id);

CREATE UNIQUE INDEX IF NOT EXISTS idx_unq_modelo_motor ON site_modelo_motores(modelo_id, motor_id);
CREATE INDEX IF NOT EXISTS idx_site_modelo_motores_modelo ON site_modelo_motores(modelo_id);
CREATE INDEX IF NOT EXISTS idx_site_modelo_motores_motor ON site_modelo_motores(motor_id);
