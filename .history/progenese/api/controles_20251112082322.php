...
function logActivity(string $acao, string $entidade, ?int $entidadeId, ?int $barcoId, string $descricao): void {
  if (session_status() !== PHP_SESSION_ACTIVE) {
    // Usa mesma função de usuarios.php se existir; fallback para session_start simples
  ...
  execute('INSERT INTO atividades (user_id, usuario, acao, entidade, entidade_id, barco_id, descricao, ip) VALUES (:user_id, :usuario, :acao, :entidade, :entidade_id, :barco_id, :descricao, :ip)', [
    ':user_id' => $userId,
    ':usuario' => $usuarioNome,
    ':acao' => $acao,
    ':entidade' => $entidade,
