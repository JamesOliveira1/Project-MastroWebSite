///////////////////////////     estaleiro         ///////////////////////////
    ...
    function undoLastAction() {
      ...
      if (ok) {
        ...
        updateUndoButtonState();
        isDirty = true;
        setStatusMessage('A ultima ação foi desfeita, será necessário salvar novamente', 'info');
      } else {
        setStatusMessage('erro ao desfazer - a posição original não está mais disponível', 'danger');
      }
    }
    /**
