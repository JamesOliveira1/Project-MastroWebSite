          ...
          slot.innerHTML = `
            <div class="slot-content">
              ...
              <div class="boat-info">
                ...
                <div class="boat-progress">${boat.progress || 0}% concluidos</div>
              </div>
            </div>
      ...
      if (completedBoats.length === 0) {
        container.innerHTML = `
          <div class="empty-state">
            ...
            <p>Nenhum projeto concluido ainda</p>
          </div>
        `;
      } else {
        container.innerHTML = completedBoats.map(boat => `
          <div class="completed-boat" draggable="true" data-boat-id="${boat.id}">
            ...
            <div class="completion-date">Concluido em ${boat.completedDate || boat.createdDate}</div>
          </div>
        `).join('');
