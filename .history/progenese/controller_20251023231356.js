...
// Novas funções de acesso cru à API para uso pelo auxiliar.js
async function listarBarcos() { return apiRequest('listar', {}, 'GET'); }
async function listarOcupacao() { return estaleiroRequest('listar_ocupacao', {}, 'GET'); }
async function salvarOcupacao(ocupacoes) { return estaleiroRequest('salvar_ocupacao', { ocupacoes }, 'POST'); }
// Expor API no escopo global
window.EstaleiroAPI = { apiRequest, estaleiroRequest, listarBarcos, listarOcupacao, salvarOcupacao };

  

// Remover bootstrap de UI daqui; o auxiliar.js assumirá a inicialização da página
document.addEventListener('DOMContentLoaded', function() {
  // Bootstrap de UI movido para auxiliar.js
});
