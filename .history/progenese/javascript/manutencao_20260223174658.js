...
let equipamentos = [
    { 
        ...
        imagem: '',
        manutencoes: [
            { data: '2023-06-10', tipo: 'Preventiva', descricao: 'Troca de escovas e limpeza interna', tecnico: 'João Silva' },
            { data: '2023-12-05', tipo: 'Corretiva', descricao: 'Troca do cabo de energia', tecnico: 'Assistência Técnica' }
        ]
    },
    { 
        id: 2, 
        ...
        imagem: '',
        manutencoes: [
             { data: '2023-02-15', tipo: 'Preventiva', descricao: 'Afiação do disco', tecnico: 'Carlos Afiação' }
        ] 
    },
    { 
        id: 3, 
        ...
        imagem: '',
        manutencoes: [
            { data: '2022-05-12', tipo: 'Preventiva', descricao: 'Troca de óleo e filtros', tecnico: 'Interno' },
            { data: '2023-05-15', tipo: 'Preventiva', descricao: 'Troca de óleo e verificação de correia', tecnico: 'Interno' }
        ]
    }
];
                    ...
                    <table class="maintenance-table">
                        ...
                        <tbody>
                            ${equip.manutencoes.map(m => {
                                let dataM = m.data;
                                const partsM = m.data.split('-');
                                if(partsM.length === 3) dataM = `${partsM[2]}/${partsM[1]}/${partsM[0]}`;
                                return `
                                <tr>
                                    <td>${dataM}</td>
