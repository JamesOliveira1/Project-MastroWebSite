            ...
            <div class="flip-container" onclick="this.classList.toggle('flipped')">
                <div class="flipper">
                    ...
                    <div class="back">
                        ...
                        <div class="back-footer" onclick="abrirModalEdicao(${molde.id}, event)" onmouseover="this.style.backgroundColor='#b6dfff'" onmouseout="this.style.backgroundColor='transparent'">
