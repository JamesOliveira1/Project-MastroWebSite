...
function renderSeries(items) {
    ...
    items.forEach(it => {
        ...
        btnDel.onclick = () => { currentSeriesId = it.id; confirmDeleteSeriesInline(); };
...
function confirmDeleteSeriesInline() {
    if (!currentSeriesId) return;
    if (confirm('Tem certeza que deseja excluir o item de série?')) {
        deleteSeries();
    }
}
