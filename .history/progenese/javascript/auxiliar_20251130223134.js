...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function renderDocumentos(docs) {
    ...
    docs.forEach(doc => {
      ...
      const downloadBtn = link ? `<a href="${link}" class="btn btn-sm btn_estaleirooff" style="display: inline;" download aria-label="Download" title="Download"><i class="bi bi-download"></i></a>` : '<span class="text-muted">—</span>';
      tr.innerHTML = `
