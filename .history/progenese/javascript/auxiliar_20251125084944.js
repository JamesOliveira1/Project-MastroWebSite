...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function renderDocumentos(docs) {
    ...
    docs.forEach(doc => {
      ...
      const downloadBtn = link ? `<a href="${link}" class="btn btn-sm btn_estaleiro" download aria-label="Download" title="Download"><i class="bi bi-download"></i></a>` : '<span class="text-muted">—</span>';
      tr.innerHTML = `
        ...
        <td class="text-end" style="padding-right: 20px;">
          <button type="button" class="btn btn-sm btn_estaleirooff me-2" data-bs-toggle="modal" data-bs-target="#modalEditDocumento" onclick="window.openEditDocumento(${Number(doc.id)})" aria-label="Editar" title="Editar">
