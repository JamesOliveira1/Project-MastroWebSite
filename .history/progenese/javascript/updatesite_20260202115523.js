...
function closeMotorModal() {
    ...
    // Verifica se bootstrap está definido globalmente
    if (typeof bootstrap !== 'undefined' && bootstrap.Modal) {
        ...
        // Fallback se bootstrap.Modal não estiver acessível (ex: usando jQuery)
        const closeBtn = modalEl.querySelector('[data-bs-dismiss="modal"]');
        if (closeBtn) {
            closeBtn.click();
        } else {
            // Último recurso: remover classes manualmente (não recomendado mas funcional)
