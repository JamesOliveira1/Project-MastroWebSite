...
function initEquipamentos() {
    ...
    if (btnRemoverFoto) {
        btnRemoverFoto.addEventListener('click', () => {
            ...
            // UI Feedback
            document.getElementById('equipImagemFeedback').style.display = 'none';
            document.getElementById('equipImagemAvisoRemocao').style.display = 'block';
                        ...
                        <table class="table table-striped table-hover align-middle mb-0">
                            <thead class="table-dark">
                                <tr>
                                    ...
                                    <th class="text-center" style="padding-right: 20px;">Concluída</th>
                                </tr>
                            </thead>
                            <tbody>
                                ${equip.manutencoes.map(m => {
                                    ...
                                    if (m.tipo === 'Preventiva') badgeClass = 'bg-success preventiva1';
                                    else if (m.tipo === 'Corretiva') badgeClass = 'bg-warning text-dark corretiva1';
                                    else if (m.tipo === 'Preditiva') badgeClass = 'bg-info text-dark preditiva1';
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ${m.os ? `<a href="#" class="text-primary" title="Ver OS"><i class="bi bi-clipboard2-check" style="font-size: 1.1rem;"></i></a>` : '-'}
                                        </td>
                        ...
                        <h4>
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <button class="btn btn-sm btn-outline-primary" onclick="addManutencao(${equip.id}, event)">
                                    <i class="bi bi-wrench-adjustable"></i> Registrar Manutenção
                                </button>
                            </div>
                        </h4>
...
function editarEquipamento(id) {
    ...
    const feedback = document.getElementById('equipImagemFeedback');
    const nomeSpan = document.getElementById('equipImagemNome');
    const avisoRemocao = document.getElementById('equipImagemAvisoRemocao');

    // Resetar UI
    if (feedback) feedback.style.display = 'none';
    if (avisoRemocao) avisoRemocao.style.display = 'none';
    ...
    if (equip.imagem && !equip.imagem.includes('semfoto.png')) {
        ...
        // Mostrar nome do arquivo existente (extrair do path)
