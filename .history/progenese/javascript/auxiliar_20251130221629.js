    ...
    docs.forEach(doc => {
      ...
      tr.innerHTML = `
        ...
        <td class="text-end" style="padding-right: 20px;">
          <button  type="button" class="btn btn-sm btn_estaleirooff me-2" data-bs-toggle="modal" data-bs-target="#modalEditDocumento" style="display: inline;" onclick="window.openEditDocumento(${Number(doc.id)})" aria-label="Editar" title="Editar">
