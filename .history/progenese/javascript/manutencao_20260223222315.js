                    ...
                    <div class="equipment-details-flex">
                        <div class="equipment-image-container">
                            ...
                            <div class="mt-2 text-center">
                                <a href="javascript:void(0)" class="equipment-status-link ${statusClass.includes('bg-') ? '' : statusClass} ${statusClass.includes('bg-') ? statusClass : ''}" onclick="alterarStatus(${equip.id}, event)" style="text-decoration: none; display: inline-block; margin-top: 5px;">${equip.status}</a>
                            </div>
                        </div>
