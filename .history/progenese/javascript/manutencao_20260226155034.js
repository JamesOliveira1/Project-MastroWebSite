        ...
        if (result.success) {
            ...
            if (targetId) {
                ...
                setTimeout(() => {
                    ...
                    if (newItem) {
                        // Se já estava aberto antes, toggleDetails fecharia.
                        // Mas como carregarEquipamentos recria o DOM, ele nasce fechado (sem classe active).
                        // Então chamar toggleDetails aqui deve abrir.
                        toggleDetails(targetId);
                        
                        // Scroll para o item para melhor UX
