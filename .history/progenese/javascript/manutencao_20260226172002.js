    ...
    const renderSearchResults = (items, offset, limit) => {
        ...
        resultsBody.innerHTML = items.map(item => {
            ...
            <tr>
                ...
                <td>${nome}</td>
                <td class="text-end">
                    <button type="button" class="btn btn-sm btn-link p-0 text-primary" onclick="selecionarEquipBusca('${safeCodigo}', '${safeNome}')">
                        Selecionar
                    </button>
                </td>
            </tr>
...
window.selecionarEquipBusca = (codigo, item) => {
    ...
    // Manter resultados visíveis para permitir troca de seleção se desejado
