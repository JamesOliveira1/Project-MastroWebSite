...
function salvarEquipamento() {
    ...
    // Se selecionou arquivo, usaria o URL do preview como fake (embora preview não apareça no modal)
    if (fileInput.files.length > 0) {
        // Mock: No mundo real, aqui você enviaria o arquivo. 
        // Para o mock, vamos usar um placeholder se houver arquivo.
        imagemAtual = '../assets/img/ferramentas/default_tool.png'; 
    } else if (id) {
