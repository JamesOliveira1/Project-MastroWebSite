...
Mesa de cabine
Mesa de proa
Monitor NSS EVO3S 12
Monitor NSS EVO3S 16
Monitor S2009
...
Transducer Airmar 1kW Thru-Hull
Ulterra112Libras
...
const boatOptions = {
  ...
  "7XS": {
    ...
    itens:
      "4 Bombas de porão com automático, Escada de popa em aço inox, Fiação elétrica estanhada e codificada, Gaiuta 19 polegadas, Luzes de navegação, Posto de comando fechado, 2 Baterias Náuticas de 105 Amp, Direção hidráulica",
    options: [
  ...
  "8CC": {
    ...
    itens:
      "Três baterias náuticas, Assentos rebatíveis de popa, 6 Bombas de porão com automático, Chuveiro de popa, Direção hidráulica, Escada de popa em aço inox, Estofamento em courvin anti-mofo, Fiação elétrica estanhada e codificada, Luzes de navegação, Porta caniço no costado",
    options: [
      { name: "Caixas de peixe removíveis", price: "1640,87" },
      { name: "Capa de Proteção", price: "3500,00" },
      { name: "Carreta de encalhe", price: "16900,00" },
      ...
      { name: "Monitor multifuncional GO 9", price: "16561,28" },
      { name: "Monitor multifuncional GO 7", price: "6899,00" },
      { name: "Monitor S2009", price: "11140,52" },
      { name: "Piloto automático", price: "19302,00" },
      { name: "Pintura de casco", price: "7000,00" },
      { name: "Piso sintético", price: "11880,00" },
      { name: "Piso sintético em EVA", price: "8745,30" },
      { name: "Radar Halo20", price: "22604,40" },
      { name: "Radio VHF RS20", price: "4606,00" },
      { name: "Radio VHF RS40", price: "11422,00" },
      { name: "Radio VHF RS40B", price: "14208,52" },
      { name: "Sensor Structure Scan", price: "4618,00" },
      { name: "Toldo articulado", price: "4780,00" },
      { name: "Transducer Airmar 1kW Thru-Hull", price: "17164,00" },
      { name: "T-Top", price: "9200,00" },
  ...
  "8XS": {
    ...
    itens:
      "6 Bombas de porão com automático, Escada de popa em aço inox, Fiação elétrica estanhada e codificada, Gaiuta 19 polegadas, Luzes de navegação, Posto de comando fechado, 3 Baterias Náuticas de 105 Amp, Direção hidráulica",
    options: [
      { name: "2 vigias laterais", price: "2423,36" },
  ...
  "8.5XS": {
    ...
    itens:
      "3 Baterias Náuticas de 105 Amp, 6 Bombas de porão com automático, Assentos rebatíveis de popa, Escada de popa em aço inox, Fiação elétrica estanhada e codificada, Guarda-mancebo em inox 316l, Luzes de navegação, Posto de comando fechado, Direção hidráulica",
    options: [
      { name: "2 vigias laterais", price: "2423,36" },
      { name: "Ar condicionado", price: "24707,08" },
      ...
      { name: "Luz de proa", price: "2220,00" },
      { name: "Luz subaquática (par)", price: "1028,00" },
      { name: "Monitor multifuncional GO 12", price: "25219,16" },
      { name: "Monitor multifuncional GO 9", price: "16561,28" },
      { name: "Monitor NSS EVO3S 12", price: "43306,07" },
      { name: "Monitor NSS EVO3S 16", price: "59713,31" },
      { name: "Monitor S2009", price: "11140,52" },
    ...
    powers: [
      ...
      { name: "2 YAMAHA 200hp", motorPrice: "263374,00" },
    ],
    basePrice: "765741,90",
  },
  ///////////////////////////////////////  ///////////////////////////
  "8.5CC": {
    ...
    itens:
      "3 Baterias Náuticas de 105 Amp, 6 Bombas de porão com automático, Assentos rebatíveis de popa, Chuveiro de popa, Escada de popa em aço inox, Estofamento em courvin anti-mofo, Fiação elétrica estanhada e codificada, Kit de lavagem de deck, Luzes de navegação, Porta-caniço no costado, Direção hidráulica",
    options: [
      { name: "Capa de Proteção", price: "5280,00" },
      { name: "Carreta de encalhe", price: "16900,00" },
      { name: "Guincho elétrico", price: "7230,60" },
      ...
      { name: "Radio VHF RS40B", price: "14208,52" },
      { name: "Sensor Structure Scan", price: "4618,00" },
      { name: "Sistema de som", price: "16310,00" },
      { name: "Tanques de combustível de 310l cada", price: "1800,00" },
      { name: "Terrova112Libras", price: "43800,00" },
      { name: "Teto Rígido", price: "17280,00" },
      { name: "Transducer Airmar 1kW Thru-Hull", price: "17164,00" },
      { name: "Ulterra112Libras", price: "43860,00" },
      { name: "Viveiros de popa", price: "6322,72" },
    ],
    powers: [
      { name: "2 MERCURY 200 DTS", motorPrice: "261012,00" },
  ...
  "8.5XF": {
    ...
    itens:
      "2 vigias laterais, 3 Baterias Náuticas de 105 Amp, 6 Bombas de porão com automático, Assentos rebatíveis de popa, Chuveiro de popa, Escada de popa em aço inox, Estofamento em courvin anti-mofo, Fiação elétrica estanhada e codificada, Gaiuta 19 polegadas, Guarda-mancebo em inox 316l, Kit de lavagem de deck, Luzes de navegação, Porta-caniço no costado, Targa em fibra, WC elétrico, Direção hidráulica",
    options: [
      { name: "Ar condicionado", price: "24707,08" },
      { name: "Banheiro Fechado", price: "4200,00" },
      { name: "Capa de Proteção", price: "5280,00" },
  ...
  "Commuter": {
    ...
    itens:
      "6 Bombas de porão com automático, Chuveiro de popa, Escada de popa em aço inox, Estofamento em courvin anti-mofo, Fiação elétrica estanhada e codificada, Guarda-mancebo em inox 316l, Kit de lavagem de deck, Luzes de navegação, WC elétrico, 3 Baterias Náuticas de 105 Amp, Direção hidráulica",
    options: [
      { name: "Ar condicionado", price: "24707,08" },
      { name: "Boiler", price: "9000,00" },
      { name: "Bow Thrust", price: "54860,00" },
      { name: "Capa de Proteção", price: "5280,00" },
      { name: "Carreta de encalhe", price: "26000,00" },
      { name: "Corrimão de popa", price: "1800,00" },
      ...
      { name: "Sensor Structure Scan", price: "4618,00" },
      { name: "Sistema C-Zone", price: "17398,00" },
      { name: "Sistema de som", price: "16310,00" },
  ...
  "TitanCC": {
    ...
    basePrice: "1102227,35",
  },
  ///////////////////////////////////////  ///////////////////////////
  "Cuddy": {
  description: "Cuddy - Compacto com cabine e console central.",
  itens:
    "6 Bombas de porão com automático, Chuveiro de popa, Escada de popa em aço inox, Estofamento em courvin anti-mofo, Fiação elétrica estanhada e codificada, Guarda-mancebo em inox 316l, Kit de lavagem de deck, Luzes de navegação, WC elétrico, 3 Baterias Náuticas de 105 Amp, Direção hidráulica",
  options: [
    { name: "2 vigias laterais", price: "2423,36" },
  ...
  basePrice: "1139582,99"
},
  ///////////////////////////////////////  ///////////////////////////
  "Cabin": {
  description: "Cabin - Catamarã com console central e cabine.",
  itens: "6 Bombas de porão com automático, Escada de popa em aço inox, Estofamento em courvin anti-mofo, Fiação elétrica estanhada e codificada, Luzes de navegação, WC elétrico, 3 Baterias Náuticas de 105 Amp, Direção hidráulica",
  options: [
    { name: "Capa de Proteção", price: "5280,00" },
    { name: "Corrimão de popa", price: "1800,00" },
    { name: "Geladeira Elétrica", price: "2950,00" },
  ...
  .addEventListener("submit", function (event) {
    ...
    grecaptcha.execute("6LfEIoYqAAAAAH-P0jb0mVzWDm4bkbmgXHpk7jsL", { action: "submit" })
      .then(function (token) {
        ...
        formData.append(
          "clientLastName",
          form.querySelector("#clientLastName").value || ""
        );
        ...
        formData.append(
          "phoneCustom",
          form.querySelector("#phoneCustom").value || ""
        );
        formData.append(
          "additionalNotes",
